...
$deger3=$_POST["header10_arkaplan"];
$deger4=$_POST["header10_yazi_rengi"];
setcookie("sayfaEkle[header10_yazi]",$deger1,time()+3600);
setcookie("sayfaEkle[header10_resim1]",$fileName1,time()+3600);
setcookie("sayfaEkle[header10_arkaplan]",$deger3,time()+3600);
setcookie("sayfaEkle[header10_yazi_rengi]",$deger4,time()+3600);
